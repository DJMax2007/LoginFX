...
public class ReturnPage {
    ...
    @FXML
    protected void onPhoneLoginClick() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("email_login.fxml"));
            Scene newScene = new Scene(loader.load());
            Stage currentStage = (Stage) ForgotUsername.getScene().getWindow();
            currentStage.setScene(newScene);
            currentStage.show();
        } catch (IOException e) {
            e.printStackTrace();
